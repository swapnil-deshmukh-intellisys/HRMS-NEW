            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              {[
                ...
                },
                {
                  ...
                  summary: "Same-day leave requests must be submitted before 1:00 PM.",
                  detail: "Applying for present-day leave is restricted and blocked after 1:00 PM (the half-shift milestone) to prevent operational bottlenecks and ensure predictability for the team."
                },
                {
