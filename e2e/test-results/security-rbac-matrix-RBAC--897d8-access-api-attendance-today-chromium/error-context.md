...
- Name: security\rbac-matrix.spec.ts >> RBAC Security Matrix @security >> Role: HR >> CAN access /api/attendance/today
- Location: tests\security\rbac-matrix.spec.ts:28:13

# Error details

```
Error: [ApiClient] Auth file not found for role "hr". Did global setup run?
```
