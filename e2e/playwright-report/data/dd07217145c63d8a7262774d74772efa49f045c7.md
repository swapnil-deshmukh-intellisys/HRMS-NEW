...
- Name: integration\inter-module.spec.ts >> Inter-Module Integration >> Employee onboarding -> Default state auto-creation @integration @onboarding
- Location: tests\integration\inter-module.spec.ts:23:7

# Error details

```
Error: [ApiClient] Auth file not found for role "admin". Did global setup run?
```
